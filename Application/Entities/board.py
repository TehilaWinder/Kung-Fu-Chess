...
class Board:
    def __init__(self):
        ...
        self.height = 0
        self.width = 0
        self.last_captured = cg.EMPTY_CELL
    ...
    def execute_move(self, move):
        ...
        if captured_piece != cg.EMPTY_CELL and captured_piece.is_king():
            self.set_piece_at(r_to, c_to, move.piece)
    ...
    def resolve_arrival(self, move):
        ...
        מעדכנת את last_captured בכל מקרה, כדי שהקורא ידע אם בכלל הייתה אכילה."""
